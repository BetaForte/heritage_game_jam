...
public class MySynchronization : MonoBehaviour, IPunObservable
{
    ...
    {
        //only if photonView is the player.
        if (stream.IsWriting)
        {
            //The photonView is mine and i am the one who controls this player.
        ...
        {
            //On my player object that exists in remote player's game.
